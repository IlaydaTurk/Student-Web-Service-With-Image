...
public class StudentTestService {
	...
	public Response getStudentDetails() throws IOException {
		...
		st.setLastName("Turk");
		st.setAge(21);
		byte[] encodedByte = st.convertImage("C:\\Users\\user\\Desktop\\Joker_0026.jpg");
		
		byte[] decodedByte = Base64.getDecoder().decode(encodedByte);
		InputStream in = new ByteArrayInputStream(decodedByte);
		BufferedImage bImageFromConvert = ImageIO.read(in);

		ImageIO.write(bImageFromConvert, "jpg", new File("C:\\Users\\user\\Desktop\\Base64ConvertJoker.jpg"));
		return Response.status(200).entity(st.getFirstName()+ " " + st.getLastName()+ " " + st.getAge() + " " + encodedByte + imageclass).build();
	...
	//http://localhost:8080/StudentRestExample/crunchify/studentservice/testservice
	...
	//http://localhost:8080/StudentRestExample/crunchify/studentservice/displayservice?firstname=ilayda&lastname=turk&age=21
